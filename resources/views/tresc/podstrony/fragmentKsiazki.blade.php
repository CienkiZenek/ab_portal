...
@section('tresc')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('naszaKsiazka')}}" class="color-glowny">"Boży wojownik. Opowieść o św. Andrzeju Boboli"</a></li>
            <li class="breadcrumb-item active" aria-current="page">Fragment książki</li>
        </ol>
    </nav>
    {{-- Koniec breadcrumb--}}
    {{-- h1 na podstonie--}}
    ...
    <div class="row mt-5">
        <div class="col-12 text-center">
            <h1 class="h1_podstrony fs-5 color-glowny">Fragment książki</h1>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-8 col-md-12 p-4 shadow-4">
